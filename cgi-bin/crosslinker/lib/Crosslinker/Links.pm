...
sub print_ms2_link    #Creates link to ms/2
{
   ...
   my ( $MSn_string, $d2_MSn_string, $sequence, $modification, $best_x, $best_y, $xlinker_mass, $mono_mass_diff, $top_10, $xlink_res, $table ) = @_;
...
{
   my (
        $MSn_string,        $d2_MSn_string,    $mz,                    $charge,            $sequences,    $isotopic_shift,
        $mass_of_deuterium, $mass_of_hydrogen, $mass_of_carbon13,      $mass_of_carbon12,  $cut_residues, $xlinker_mass,
        $mono_mass_diff,    $reactive_site,    $user_protein_sequence, $static_mod_string, $varible_mod_string
   ) = @_;
   print '
