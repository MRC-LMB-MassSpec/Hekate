...
<input type="hidden" name="pastedta1"  value="',       $MSn_string,            '">';
    ...
    print '<input type="hidden" name=".cgifields" value="dataupload"  /><input type="hidden" name=".cgifields" value="ionseries_a"  /><input type="hidden" name=".cgifields" value="tolerancemeasure"  /><input type="hidden" name=".cgifields" value="decoy"  />
