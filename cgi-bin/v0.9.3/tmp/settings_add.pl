...
if ( !defined $query->param('type') ) {
    ...
    my $dbh = connect_conf_db;
    add_conf( $dbh, $query->param('type'), $query->param('name'), $query->param('setting1'), $query->param('setting2'), $query->param('setting3'), $query->param('setting4'), $query->param('setting5') );
